...
def check_upstream_lock() -> list[str]:
    ...
    _require(ars["commit"] == "cb2f4e07019e1cd72881547e91d880ec7cc0d7fc", f"academic-research-skills lock is stale: {ars['commit']}")
    ...
    return ["upstream lock pins academic-research-skills@cb2f4e0"]
